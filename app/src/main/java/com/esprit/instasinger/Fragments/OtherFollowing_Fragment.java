...
public class OtherFollowing_Fragment extends Fragment {
    ...
    public OtherFollowing_Fragment() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            myRef.child("following").child(mParam1).addChildEventListener(new ChildEventListener() {
                @Override
