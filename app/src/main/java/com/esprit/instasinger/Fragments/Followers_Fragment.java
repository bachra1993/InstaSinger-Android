...
public class Followers_Fragment extends Fragment {
     ...
     * @return A new instance of fragment Followers_Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Followers_Fragment newInstance(String param1, String param2) {
        Followers_Fragment fragment = new Followers_Fragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        myRef.child("followers").child(user.getUid()).addChildEventListener(new ChildEventListener() {
            @Override
